...
% Vertically centre the whole certificate: equal \fill above and below.
\vspace*{\fill}

\begin{center}
{\Large\bfseries Bona fide Certificate}\\[1.2cm]
...
of this project.
First, we would like to thank our project supervisor Dr.Rabindra Bista for his valuable guidance,
continuous support, and constructive feedback throughout the development of this
project. his insights and encouragement played a crucial role in shaping both the
...
\rfig{pica/forgotpw.png}{Forgot-password page --- requests a single-use reset link}{fig:forgotpw}
